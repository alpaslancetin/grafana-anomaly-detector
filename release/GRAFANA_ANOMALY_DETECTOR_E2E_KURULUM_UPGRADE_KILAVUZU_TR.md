# Grafana Anomaly Detector v1.4.0 - Uctan Uca Kurulum, Upgrade ve Operasyon Kilavuzu

Bu dokuman `Grafana Anomaly Detector v1.4.0` paketlerini sifirdan kurmak, mevcut kurulumu upgrade etmek, exporter'i ayaga kaldirmak, score feed akisini anlamak, alert olusturmak ve sorun gidermek icin hazirlandi.
...
PACKAGE_CONTENTS_v1.4.0_TR.md
README.md
GITHUB_RELEASE_NOTES_v1.4.0.md
...
v1.4.0 son tasarimda kullanici tek hedef secer. Bu karar kasitlidir.
...
```text
grafana_anomaly_build_info{version="1.4.0"} 1
```
...
grep -n '"version": "1.4.0"' /data/grafana/plugins/alpas-anomalydetector-panel/plugin.json
```
...
```text
Plugin + exporter v1.4.0 paket seti kontrollu kurulum ve upgrade icin hazirdir.
```
